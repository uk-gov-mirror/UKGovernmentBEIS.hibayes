...
::: {.feature-card}
### 🤖 Agent skills
Two [Claude Code skills](agent-skills.qmd) ship with the package, giving coding agents both the pipeline mechanics and the statistical workflow.
:::
...
Ready to dive in? Check out our [Getting Started Guide](getting-started.qmd) for installation instructions and a tutorial. If you work with a coding agent, see [Claude Code Skills](agent-skills.qmd).
